...
def entries : Array Entry := #[
  ...
  { name := "Token2022ExtOpen", digest := "40648bdc16780654" },
  { name := "NonceLife", digest := "c3fa20791322ace7" },
  ...
  { name := "HashWords", digest := "9b140013a7e21f45" },
  { name := "HashDataSha", digest := "175bc3dc0c726531" },
  { name := "HashDataKeccak", digest := "2f424c1bc65d97e4" },
  ...
  { name := "TokenMultisig", digest := "a31abd667d925ad9" },
